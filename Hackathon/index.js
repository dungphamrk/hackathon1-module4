...
class Feedback {
    constructor(id, name, score) {
      ...
      `;
        ...
        this.handleScoreButtonClick = () => {
            btnScoreGroup === null || btnScoreGroup === void 0 ? void 0 : btnScoreGroup.addEventListener("click", (e) => {
                const targetButton = e.target.closest(".btn-score");
                console.log(targetButton);
                if (targetButton) {
                    const allButtons = btnScoreGroup === null || btnScoreGroup === void 0 ? void 0 : btnScoreGroup.querySelectorAll(".btn-score");
                    allButtons === null || allButtons === void 0 ? void 0 : allButtons.forEach((button) => button.classList.remove("active"));
    ...
    updateFeedback() {
        listFeedbackContent === null || listFeedbackContent === void 0 ? void 0 : listFeedbackContent.addEventListener("click", (e) => {
            if (e.target && e.target.matches(".fa-pen-to-square")) {
                const idUpdate = e.target.id.split("_")[1];
                updatingFeedback = listFeedbackLocal.find((fb) => fb.feedbackId === idUpdate);
                if (updatingFeedback) {
        ...
        btnSend === null || btnSend === void 0 ? void 0 : btnSend.addEventListener("click", (e) => {
            e.stopPropagation();
            Swal.fire({
                title: "Are you sure?",
                text: "You want do it?",
            ...
            if (deleteButton) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        const filterFeedback = listFeedbackLocal.filter((fb) => fb.feedbackId !== idDelete);
...
let feedback = "";
inputContainer === null || inputContainer === void 0 ? void 0 : inputContainer.addEventListener("click", () => {
    feedbackInput === null || feedbackInput === void 0 ? void 0 : feedbackInput.focus();
});
feedbackInput === null || feedbackInput === void 0 ? void 0 : feedbackInput.focus();
...
const validateData = () => {
    feedbackInput === null || feedbackInput === void 0 ? void 0 : feedbackInput.addEventListener("input", (e) => {
